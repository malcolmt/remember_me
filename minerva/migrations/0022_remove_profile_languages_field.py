...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('minerva_profile', 'language')


    def backwards(self, orm):
        
        # Adding field 'Profile.language'
        db.add_column('minerva_profile', 'language', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)
