...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Word.lang_code'
        db.add_column('minerva_word', 'lang_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['minerva.Language'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Word.lang_code'
        db.delete_column('minerva_word', 'lang_code_id')
    ...
    models = {
        ...
        'minerva.word': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['minerva.Language']", 'null': 'True'}),
