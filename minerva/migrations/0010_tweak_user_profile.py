...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.student'
        db.alter_column('minerva_userprofile', 'student_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))

        # Changing field 'UserProfile.language'
        db.alter_column('minerva_userprofile', 'language', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.student'
        db.alter_column('minerva_userprofile', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True))

        # Changing field 'UserProfile.language'
        db.alter_column('minerva_userprofile', 'language', self.gf('django.db.models.fields.CharField')(max_length=3))
