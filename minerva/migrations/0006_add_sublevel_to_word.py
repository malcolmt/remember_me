...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Word.sub_level'
        db.add_column('minerva_word', 'sub_level', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Word.sub_level'
        db.delete_column('minerva_word', 'sub_level')
