...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('minerva_userprofile', (
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
    ...
    models = {
        ...
        'minerva.userprofile': {
            ...
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'primary_key': 'True'})
        },
        'minerva.word': {
